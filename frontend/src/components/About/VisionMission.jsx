...
const VisionMission = () => {
    return (
        <div>
            ...
            <div className="relative bg-secondary-100 rounded-lg p-6 mx-auto mb-12">
                ...
                <div className="border rounded-lg p-6 h-fit text-center text-black">
                    <section>
            ...
            <div className="relative bg-secondary-100 rounded-lg p-6 mx-auto">
                ...
                <section>
                    <ul className="list-disc pl-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 p-6 text-black">
