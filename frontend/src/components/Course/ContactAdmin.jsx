...
const ContactAdmin = () => {
  return (
    <div className="flex justify-center rounded-lg bg-secondary-400 text-color-text-2 font-medium text-base m-9 p-4">
      ...
      <a href="https://web.telegram.org" target="_blank" class="underline hover:text-blue-800 mx-1">
        Telegram
      </a>{' '}
      atau{' '}
      <a href="https://www.whatsapp.com/" target="_blank" class="underline hover:text-blue-800 ml-1">
        Whatsapp
      </a>
    </div>
  );
