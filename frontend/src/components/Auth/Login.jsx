...
function Login() {
  ...
  return (
    <>
      <div className="w-full flex items-center justify-center mt-28 mb-20">
        <div className="max-w-[330px] sm:max-w-[450px]">
          <div className="max-w-full flex justify-center sm:mb-5">
            <img className="text-center w-6 h-6 sm:w-12 sm:h-full" src="/kreatikode-logo.png" alt="KreatiKode Logo" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mt-4 sm:mt-8" autoComplete="off">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex mt-2">
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="inline-flex items-center px-4 text-sm text-gray-900 bg-gray-100 hover:bg-gray-200 border-2 border-s-0 border-gray-200 rounded-e-md">
                  {showPassword ? (
                    <svg className="w-6 h-6 text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                      <path
                        fillRule="evenodd"
            ...
            <div className="mt-8 flex flex-col gap-y-4">
              <button type="submit" className="w-full py-3 bg-primary-500 text-white rounded-xl font-semibold text-md hover:bg-blue-600 transition duration-200 flex items-center justify-center" disabled={isSubmitting}>
                {isSubmitting ? (
                  <>
      ...
      <ResendEmailModal isOpen={showVerificationModal} onClose={() => setShowVerificationModal(false)} email={userEmail} />
    </>
  );
}
