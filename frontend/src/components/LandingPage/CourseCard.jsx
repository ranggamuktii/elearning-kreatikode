...
const CourseCard = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center">
      {courses.map((course) => (
        <div key={course._id} onClick={() => (window.location.href = `/course/${course._id}`)} className="w-[250px] sm:w-[330px]  cursor-pointer hover:scale-97 transition-transform duration-500">
